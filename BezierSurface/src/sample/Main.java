...
//            angleX.set(anchorAngleX - anchorY - event.getSceneY());
    ...
    private List<Point> points() {
        return new ArrayList<>(Arrays.asList(
                ...
                new Point(200, 200, 0, Color.GREEN),
                new Point(300, 200, 100, Color.GREEN),
                new Point(400, 500, 200, Color.GREEN),
                new Point(500, 100, 200, Color.GREEN),
                new Point(600, 400, 300, Color.GREEN),
                new Point(700, 400, 400, Color.GREEN),
                new Point(900, 300, 500, Color.GREEN)
        ));
    }
